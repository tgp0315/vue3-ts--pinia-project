...
export const loginApi = (params: Login.ReqLoginForm) => {
  return request.post<Login.ResLogin>(PORT1 + `/login`, params, { loading: false }) // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  return request.get<Menu.MenuOptions[]>(PORT1 + `/menu/list`, {}, { loading: false })
...
export const getAuthButtonListApi = () => {
  return request.get<Login.ResAuthButtons>(PORT1 + `/auth/buttons`, {}, { loading: false })
